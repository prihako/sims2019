...
(select id from endpoint_rcs where endpoint_id=(select id from endpoints where code='chws3') and rc='00')),

((select id from endpoint_rcs where endpoint_id is null  and rc='01'),
(select id from endpoint_rcs where endpoint_id=(select id from endpoints where code='chws3') and rc='01')),

((select id from endpoint_rcs where endpoint_id is null  and rc='ZZ'),
(select id from endpoint_rcs where endpoint_id=(select id from endpoints where code='chws3') and rc='89')),

((select id from endpoint_rcs where endpoint_id is null  and rc='SU'),
(select id from endpoint_rcs where endpoint_id=(select id from endpoints where code='chws3') and rc='91'))
/
...
(select id from endpoint_rcs where endpoint_id=(select id from endpoints where code='chws3') and rc='87')),

((select id from endpoint_rcs where endpoint_id=(select id from endpoints where code='bils0') and rc='10'),
(select id from endpoint_rcs where endpoint_id=(select id from endpoints where code='chws3') and rc='B5')),
...
(select id from endpoint_rcs where endpoint_id=(select id from endpoints where code='chws3') and rc='B8')),
