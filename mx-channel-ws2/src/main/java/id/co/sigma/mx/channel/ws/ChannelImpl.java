...
import id.co.sigma.mx.channel.ws.wsdl.InquiryResponse;
import id.co.sigma.mx.channel.ws.wsdl.InquiryResponse2;
import id.co.sigma.mx.channel.ws.wsdl.PaymentRequest;
import id.co.sigma.mx.channel.ws.wsdl.PaymentResponse;
...
public class ChannelImpl implements Transport<WsMessage>, BillPaymentServiceSoap {
	private static final transient Logger LOGGER = LoggerFactory.getLogger(ChannelImpl.class);
	...
	public PaymentResponse payment(PaymentRequest request) {
		...
		LOGGER.debug("------------- responseData Payment : "+responseData.toString());
	...
	public ReversalResponse reverse(ReversalRequest request) {
		...
		LOGGER.debug("------------- responseData Reverse : "+responseData.toString());
	...
	public InquiryResponse inquiry(InquiryRequest request) {
		...
		LOGGER.debug("------------- responseData Inquiry : "+responseData.toString());
