...
public class PaymentResponse {
	...
	public PaymentResponse convertFromMap(Map map) {
    	...
    	paymentResponse.setBillKey1(map.get("billKey1").toString());
    	paymentResponse.setBillKey2(map.get("billKey2").toString());
    	paymentResponse.setBillKey3(map.get("billKey3").toString());
