...
public class PaymentManagerControllerService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/F:/testCXF/endpoint-reor01/src/main/resources/wsdl/Reor.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PaymentManagerControllerService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/F:/testCXF/endpoint-reor01/src/main/resources/wsdl/Reor.wsdl");
        }
        WSDL_LOCATION = url;
    }
