...
@javax.jws.WebService(
                      ...
                      wsdlLocation = "classpath:/wsdl/perangkat.wsdl",
...
public class PaymentManagerControllerPortTypeImpl implements PaymentManagerControllerPortType {
     ...
     */
    public id.co.sigma.mx.channel.perangkat.ReversalResult reversal(id.co.sigma.mx.channel.perangkat.ReversalRequest req) { 
        LOG.info("Executing operation reversal");
        System.out.println(req);
        try {
            id.co.sigma.mx.channel.perangkat.ReversalResult _return = null;
            return _return;
     ...
     */
    public id.co.sigma.mx.channel.perangkat.PaymentResult payment(id.co.sigma.mx.channel.perangkat.PaymentRequest req) { 
        LOG.info("Executing operation payment");
        System.out.println(req);
        try {
            id.co.sigma.mx.channel.perangkat.PaymentResult _return = null;
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
     ...
     */
    public id.co.sigma.mx.channel.perangkat.InquiryResult inquiry(id.co.sigma.mx.channel.perangkat.InquiryRequest req) { 
        LOG.info("Executing operation inquiry");
        System.out.println(req);
        try {
            id.co.sigma.mx.channel.perangkat.InquiryResult _return = null;
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
