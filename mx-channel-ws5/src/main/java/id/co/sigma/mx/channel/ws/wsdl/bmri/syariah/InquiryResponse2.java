 ...
 *         &lt;element name="billDetails" type="{bankmandiri.h2h.billpayment.ws}ArrayOfBillDetail" minOccurs="0"/>
...
public class InquiryResponse2 {
	...
	public InquiryResponse2 convertFromMap(Map map) {
...
//    	inquiryResponse.setBillInfo25(map.get("billInfo25").toString());//no need to be filled
    	...
    	billDetails.setBillDetail(bill);
