 ...
 *         &lt;element name="status" type="{bankmandiri.h2h.billpayment.ws}Status" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PaymentResponse2 {
	...
	public PaymentResponse2 convertFromMap(Map map) {
//    	note based on BMRI-POSTEL WS Specification Documents
    	PaymentResponse2 paymentResponse = new PaymentResponse2();
    	paymentResponse.setBillInfo1(map.get("billInfo1").toString());//client name
    	paymentResponse.setBillInfo2(map.get("billInfo2").toString());//period begin - yyyyMMdd
    	paymentResponse.setBillInfo3(map.get("billInfo3").toString());//period end - yyyyMMdd
//    	inquiryResponse.setBillInfo4(map.get("billInfo4").toString());//no need to be filled
//    	inquiryResponse.setBillInfo5(map.get("billInfo5").toString());//no need to be filled
//    	inquiryResponse.setBillInfo6(map.get("billInfo6").toString());//no need to be filled
//    	inquiryResponse.setBillInfo7(map.get("billInfo7").toString());//no need to be filled
//    	inquiryResponse.setBillInfo8(map.get("billInfo8").toString());//no need to be filled
//    	inquiryResponse.setBillInfo9(map.get("billInfo9").toString());//no need to be filled
//    	inquiryResponse.setBillInfo10(map.get("billInfo10").toString());//no need to be filled
//    	inquiryResponse.setBillInfo11(map.get("billInfo11").toString());//no need to be filled
//    	inquiryResponse.setBillInfo12(map.get("billInfo12").toString());//no need to be filled
//    	inquiryResponse.setBillInfo13(map.get("billInfo13").toString());//no need to be filled
//    	inquiryResponse.setBillInfo14(map.get("billInfo14").toString());//no need to be filled
//    	inquiryResponse.setBillInfo15(map.get("billInfo15").toString());//no need to be filled
//    	inquiryResponse.setBillInfo16(map.get("billInfo16").toString());//no need to be filled
//    	inquiryResponse.setBillInfo17(map.get("billInfo17").toString());//no need to be filled
//    	inquiryResponse.setBillInfo18(map.get("billInfo18").toString());//no need to be filled
//    	inquiryResponse.setBillInfo19(map.get("billInfo19").toString());//no need to be filled
//    	inquiryResponse.setBillInfo21(map.get("billInfo21").toString());//no need to be filled
//    	inquiryResponse.setBillInfo22(map.get("billInfo22").toString());//no need to be filled
//    	inquiryResponse.setBillInfo23(map.get("billInfo23").toString());//no need to be filled
//    	inquiryResponse.setBillInfo24(map.get("billInfo24").toString());//no need to be filled
//    	inquiryResponse.setBillInfo25(map.get("billInfo25").toString());//no need to be filled
