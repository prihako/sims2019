...
public interface PaymentManagerControllerPortType {
    ...
    public id.co.sigma.mx.channel.endpoint.ReversalResult reversal(
        @WebParam(name = "req", targetNamespace = "")
        id.co.sigma.mx.channel.endpoint.ReversalRequest req
    );
    ...
    public id.co.sigma.mx.channel.endpoint.PaymentResult payment(
        @WebParam(name = "req", targetNamespace = "")
        id.co.sigma.mx.channel.endpoint.PaymentRequest req
    );
    ...
    public id.co.sigma.mx.channel.endpoint.InquiryResult inquiry(
        @WebParam(name = "req", targetNamespace = "")
        id.co.sigma.mx.channel.endpoint.InquiryRequest req
    );
}
