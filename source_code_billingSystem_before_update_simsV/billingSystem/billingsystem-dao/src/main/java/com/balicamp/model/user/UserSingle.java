...
//	private Boolean accountExpired;
	...
	**/
	@Column(name = "account_expired", nullable = true)
	private String accountExpireds;
	/**
	* <br/>
...
//	private Boolean credentialExpired;
	...
	**/
	@Column(name = "credential_expired", nullable = true)
	private String credentialExpireds;
	/**
	* <br/>
...
//	private boolean mustChangePassword;
	...
	**/
	@Column(name = "must_change_password", nullable = false)
	private String mustChangePasswords;
	...
	public String getAccountExpireds() {
		return accountExpireds;
	}

	public void setAccountExpireds(String accountExpireds) {
		this.accountExpireds = accountExpireds;
	}

	public String getAccountLockeds() {
		return accountLockeds;
	}

	public void setAccountLockeds(String accountLockeds) {
		this.accountLockeds = accountLockeds;
	}

	public String getCredentialExpireds() {
		return credentialExpireds;
	}

	public void setCredentialExpireds(String credentialExpireds) {
		this.credentialExpireds = credentialExpireds;
	}

	public String getMustChangePasswords() {
		return mustChangePasswords;
	}

	public void setMustChangePasswords(String mustChangePasswords) {
		this.mustChangePasswords = mustChangePasswords;
	}
...
//		setAccountLockeds(user.getAccountLocked());
...
//	}
	...
	public String toString() {
		return "UserSingle [id=" + id + ", userName=" + userName + ", userFullName=" + userFullName + ", birthDate="
				...
				+ ", enabled=" + enableds + ", accountExpired=" + accountExpireds + ", accountLocked=" + accountLockeds
				+ ", credentialExpired=" + credentialExpireds + ", mustChangePassword=" + mustChangePasswords + "]";
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((accountExpireds == null) ? 0 : accountExpireds.hashCode());
		result = prime * result + ((accountLockeds == null) ? 0 : accountLockeds.hashCode());
		...
		result = prime * result + ((credentialExpireds == null) ? 0 : credentialExpireds.hashCode());
		result = prime * result + ((email == null) ? 0 : email.hashCode());
		result = prime * result + ((enableds == null) ? 0 : enableds.hashCode());
...
//		result = prime * result + (mustChangePasswords ? 1231 : 1237);
	...
	public boolean equals(Object obj) {
		...
		if (accountExpireds == null) {
			if (other.accountExpireds != null)
				return false;
		} else if (!accountExpireds.equals(other.accountExpireds))
			return false;
		if (accountLockeds == null) {
			if (other.accountLockeds != null)
				return false;
		} else if (!accountLockeds.equals(other.accountLockeds))
			return false;
		if (activeDate == null) {
		...
		if (createdDate == null) {
			...
			return false;
		if (credentialExpireds == null) {
			if (other.credentialExpireds != null)
				return false;
		} else if (!credentialExpireds.equals(other.credentialExpireds))
			return false;
		if (email == null) {
			if (other.email != null)
				return false;
			...
			return false;
		if (enableds == null) {
			if (other.enableds != null)
				return false;
		} else if (!enableds.equals(other.enableds))
			return false;
		if (id == null) {
			if (other.id != null)
				return false;
		...
		if (locale == null) {
			...
			return false;
		if (mustChangePasswords != other.mustChangePasswords)
			return false;
		if (password == null) {
