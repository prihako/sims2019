...
// ## Images to use (specify full path)
	flipImg_open   = "arrow.gif";
	flipImg_closed = "arrow.gif";
	flipImg_static = "arrow.gif";
...
/*	"<style type=\"text/css\">" +
	...
	"ul.menu { margin-top: " + flipTopMargin + "; margin-left: " + flipLeftMargin + "; " + (flipImages ? "" : "list-style-type: none;") + " }" +
	"ul.menu ul, ul.menu li { padding-top: " + flipVerticalPadding + "; margin-left: " + flipIndentation + "; margin_right: 0px; " + (flipImages ? "" : "list-style-type: none;") + " }" +
