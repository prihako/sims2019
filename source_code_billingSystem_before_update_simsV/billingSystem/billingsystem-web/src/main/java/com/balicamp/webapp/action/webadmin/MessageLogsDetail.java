 ...
 * @version $Id: MessageLogsDetail.java 508 2013-05-28 09:06:38Z gloria.patara $
 */
...
//		String endPoint = objectParameter.getEndpointCode();
//		if (endPoint.equals("chws")) {
//			setRawMessage(objectParameter.getRaw());
//			setFormatedMessage(objectParameter.getRaw());
//		} else {
			MessageLogsDto display = getMessageLogManager().getRawMessageLogs(objectParameter);
			setRawMessage(display.getRaw());
			setFormatedMessage(display.getFormatedMessage());
