 ...
 */
public abstract class MessageLogsDetail extends AdminBasePage implements PageBeginRenderListener {
	...
	public void goBack(IRequestCycle cycle) {
		...
		messageLogsList.setTransactionLogList((List<AnalisaTransactionLogsDto>) getFields().get("transactionLogList"));
		messageLogsList.setKlienID((String) getFields().get("klienId"));
		messageLogsList.setInvoiceNo((String) getFields().get("invoiceNo"));
		messageLogsList.setStartDate2((Date) getFields().get("startDate2"));
		messageLogsList.setEndDate2((Date) getFields().get("endDate2"));
		messageLogsList.setTransactionType((String) getFields().get("transactionType"));
		messageLogsList.setTransactionId((String) getFields().get("transactionId"));
