 ...
 */
public class NewTableModel<T> implements IBasicTableModel {

	private GenericManager<T, Serializable> genericManager;
	...
	public NewTableModel(GenericManager<T, Serializable> genericManager, SearchCriteria searchCriteria,
			Map<String, String> orderMaping) {
	...
	public Iterator<T> getCurrentPageRows(int nFirst, int nPageSize, ITableColumn objSortColumn, boolean bSortOrder) {
		...
		if (entityList == null)
			entityList = genericManager.findByCriteria(searchCriteria, nFirst, nPageSize);
	...
	// properties setter
	public void setGenericManager(GenericManager<T, Serializable> genericManager) {
