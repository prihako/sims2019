...
public abstract class ActiveUsers extends BasePage implements PageBeginRenderListener, PageEndRenderListener {
	...
	public void initServerSelectionModel() {
		...
		// roles.addAll(getRoleManager().getAll());
		...
		// }
		// setServerSelectionModel(new StringPropertySelectionModel(roleStr));
		// } else {
	...
	public Object[] initActiveUsers() {
		...
		// RemoteSystemControl remote = getSystemControls().get(AUTHORIZATION);
		if (remote == null) {
			return new Object[0];
		}
