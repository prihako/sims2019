...
public abstract class Constants {
	...
	// FIXME:
	// public static Date DEVELOPMENT_DATE = new DateTime(2008, 8, 24, 0, 0, 0,
	// 0).toDate();
	public static Date DEVELOPMENT_DATE = new Date();
	...
	static public class SystemParameter {
		...
		static public class Mail {
			...
			public static final String USER_ADMIN_DOMAIN_LIST_DEFAULT = "mayora.com";
		}
	...
	static public class BillerConstants {
		public static final String BHP_CODE = "bils0";

		public static final String PERANGKAT_CODE = "per01";

		public static final String SKOR_CODE = "skor01";

		public static final String REOR_CODE = "reor01";
	...
	static public class DirectoryFTPConstants {
		...
		public static final String BHP_DIR = "bils0";

		public static final String PERANGKAT_DIR = "per01";

		public static final String SKOR_DIR = "skor01";

		public static final String REOR_DIR = "reor01";

		public static final String IAR_DIR = "iar";

		public static final String UNAR_DIR = "unar";
	...
	static public class ChannelNameConstants {
	...
	static public class FileAttribute {

		public static final String AVAILABLE = "VA";

		public static final String NOT_AVAILABLE = "NA";

	}

	static public class BillerNumberCode {

		public static final String BHP_CODE = "10";

		public static final String PERANGKAT_CODE = "70";

		public static final String SKOR_CODE = "30";

		public static final String REOR_CODE = "20";

		public static final String IAR_CODE = "50";

		public static final String UNAR_CODE = "40";
