...
public interface PaymentManagerControllerPortType {
    ...
    public com.balicamp.soap.ws.iar.ReversalResult reversal(
        @WebParam(name = "req", targetNamespace = "")
        com.balicamp.soap.ws.iar.ReversalRequest req
    );
    ...
    public com.balicamp.soap.ws.iar.PaymentResult payment(
        @WebParam(name = "req", targetNamespace = "")
        com.balicamp.soap.ws.iar.PaymentRequest req
    );
    ...
    public com.balicamp.soap.ws.iar.InquiryResult inquiry(
        @WebParam(name = "req", targetNamespace = "")
        com.balicamp.soap.ws.iar.InquiryRequest req
    );
}
