...
public class ReversalRequest {
	...
	public String toString() {
		return "ReversalRequest [language=" + language + ", trxDateTime=" + trxDateTime + ", origTrxDateTime="
				+ origTrxDateTime + ", transmissionDateTime=" + transmissionDateTime + ", origTransmissionDateTime="
				+ origTransmissionDateTime + ", companyCode=" + companyCode + ", channelID=" + channelID + ", billKey1="
				+ billKey1 + ", billKey2=" + billKey2 + ", billKey3=" + billKey3 + ", paymentAmount=" + paymentAmount
				+ ", currency=" + currency + ", transactionID=" + transactionID + ", reference1=" + reference1
