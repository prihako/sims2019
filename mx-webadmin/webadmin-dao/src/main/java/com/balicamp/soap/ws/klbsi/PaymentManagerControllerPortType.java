...
public interface PaymentManagerControllerPortType {
    ...
    public com.balicamp.soap.ws.klbsi.ReversalResult reversal(
        @WebParam(name = "req", targetNamespace = "")
        com.balicamp.soap.ws.klbsi.ReversalRequest req
    );
    ...
    public com.balicamp.soap.ws.klbsi.PaymentResult payment(
        @WebParam(name = "req", targetNamespace = "")
        com.balicamp.soap.ws.klbsi.PaymentRequest req
    );
    ...
    public com.balicamp.soap.ws.klbsi.InquiryResult inquiry(
        @WebParam(name = "req", targetNamespace = "")
        com.balicamp.soap.ws.klbsi.InquiryRequest req
    );
}
