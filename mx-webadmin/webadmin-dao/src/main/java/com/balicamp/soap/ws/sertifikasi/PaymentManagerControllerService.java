...
public class PaymentManagerControllerService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/F:/sims2019/sims_git/sims2019/mx-webadmin/webadmin-dao/src/main/resources/wsdl/perangkat.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PaymentManagerControllerService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/F:/sims2019/sims_git/sims2019/mx-webadmin/webadmin-dao/src/main/resources/wsdl/perangkat.wsdl");
        }
        WSDL_LOCATION = url;
    }
