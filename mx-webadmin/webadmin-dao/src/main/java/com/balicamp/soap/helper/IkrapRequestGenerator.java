...
import com.balicamp.soap.ws.ikrap.ArrayOfString;
import com.balicamp.soap.ws.ikrap.InquiryRequest;
import com.balicamp.soap.ws.ikrap.PaymentRequest;
import com.balicamp.soap.ws.ikrap.StringArray;

@Component
public class IkrapRequestGenerator {
	...
	public InquiryRequest genereateInquiryRequest(String invoiceNo, String clientId) {
		...
		inquiryRequest.setBillKey3(WebServiceConstant.IKRAP_TRANSACTION_TYPE);
	...
	public PaymentRequest genereatePaymentRequest(String invoiceNo, 
		...
		paymentRequest.setBillKey3(WebServiceConstant.IKRAP_TRANSACTION_TYPE);
