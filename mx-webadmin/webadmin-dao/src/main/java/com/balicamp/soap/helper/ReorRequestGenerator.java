...
import com.balicamp.soap.ws.reor.ArrayOfString;
import com.balicamp.soap.ws.reor.InquiryRequest;
import com.balicamp.soap.ws.reor.PaymentRequest;
import com.balicamp.soap.ws.reor.StringArray;

@Component
public class ReorRequestGenerator {
	...
	public InquiryRequest genereateInquiryRequest(String invoiceNo, String clientId) {
		...
		inquiryRequest.setBillKey3(WebServiceConstant.REOR_TRANSACTION_TYPE);
	...
	public PaymentRequest genereatePaymentRequest(String invoiceNo, 
		...
		paymentRequest.setBillKey3(WebServiceConstant.REOR_TRANSACTION_TYPE);
