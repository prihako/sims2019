...
public class PaymentManagerControllerPortTypeImpl implements PaymentManagerControllerPortType {
     ...
     */
    public com.balicamp.soap.ws.reor.InquiryResult inquiry(com.balicamp.soap.ws.reor.InquiryRequest req) { 
        LOG.info("Executing operation inquiry");
        LOG.info(req.toString());
        try {
        	com.balicamp.soap.ws.reor.InquiryResult _return = null;
            return _return;
     ...
     */
    public com.balicamp.soap.ws.reor.PaymentResult payment(com.balicamp.soap.ws.reor.PaymentRequest req) { 
        LOG.info("Executing operation payment");
        LOG.info(req.toString());
        try {
        	com.balicamp.soap.ws.reor.PaymentResult _return = null;
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
     ...
     */
    public com.balicamp.soap.ws.reor.ReversalResult reversal(com.balicamp.soap.ws.reor.ReversalRequest req) { 
        LOG.info("Executing operation reversal");
        LOG.info(req.toString());
        try {
        	com.balicamp.soap.ws.reor.ReversalResult _return = null;
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
