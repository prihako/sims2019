...
import com.balicamp.soap.ws.sertifikasi.ArrayOfString;
import com.balicamp.soap.ws.sertifikasi.InquiryRequest;
import com.balicamp.soap.ws.sertifikasi.PaymentRequest;
import com.balicamp.soap.ws.sertifikasi.StringArray;

@Component
public class SertifikasiRequestGenerator {
	...
	public InquiryRequest genereateInquiryRequest(String invoiceNo, String clientId) {
		...
		inquiryRequest.setBillKey3(WebServiceConstant.SERTIFIKASI_TRANSACTION_TYPE);
	...
	public PaymentRequest genereatePaymentRequest(String invoiceNo, 
		...
		paymentRequest.setBillKey3(WebServiceConstant.SERTIFIKASI_TRANSACTION_TYPE);
