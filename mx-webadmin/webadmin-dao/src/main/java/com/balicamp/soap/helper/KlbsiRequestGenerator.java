...
import com.balicamp.soap.ws.klbsi.ArrayOfString;
import com.balicamp.soap.ws.klbsi.InquiryRequest;
import com.balicamp.soap.ws.klbsi.PaymentRequest;
import com.balicamp.soap.ws.klbsi.StringArray;

@Component
public class KlbsiRequestGenerator {
	...
	public InquiryRequest genereateInquiryRequest(String invoiceNo, String clientId) {
		...
		inquiryRequest.setBillKey3(WebServiceConstant.KLBSI_TRANSACTION_TYPE);
	...
	public PaymentRequest genereatePaymentRequest(String invoiceNo, 
		...
		paymentRequest.setBillKey3(WebServiceConstant.KLBSI_TRANSACTION_TYPE);
