...
public class PaymentManagerControllerPortTypeImpl implements PaymentManagerControllerPortType {
     ...
     */
    public com.balicamp.soap.ws.ikrap.ReversalResult reversal(com.balicamp.soap.ws.ikrap.ReversalRequest req) { 
        LOG.info("Executing operation reversal");
        System.out.println(req);
        try {
        	com.balicamp.soap.ws.ikrap.ReversalResult _return = null;
            return _return;
     ...
     */
    public com.balicamp.soap.ws.ikrap.PaymentResult payment(com.balicamp.soap.ws.ikrap.PaymentRequest req) { 
        LOG.info("Executing operation payment");
        System.out.println(req);
        try {
        	com.balicamp.soap.ws.ikrap.PaymentResult _return = null;
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
     ...
     */
    public com.balicamp.soap.ws.ikrap.InquiryResult inquiry(com.balicamp.soap.ws.ikrap.InquiryRequest req) { 
        LOG.info("Executing operation inquiry");
        System.out.println(req);
        try {
        	com.balicamp.soap.ws.ikrap.InquiryResult _return = null;
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
