...
public interface PaymentManagerControllerPortType {
    ...
    public com.balicamp.soap.ws.ikrap.ReversalResult reversal(
        @WebParam(name = "req", targetNamespace = "")
        com.balicamp.soap.ws.ikrap.ReversalRequest req
    );
    ...
    public com.balicamp.soap.ws.ikrap.PaymentResult payment(
        @WebParam(name = "req", targetNamespace = "")
        com.balicamp.soap.ws.ikrap.PaymentRequest req
    );
    ...
    public com.balicamp.soap.ws.ikrap.InquiryResult inquiry(
        @WebParam(name = "req", targetNamespace = "")
        com.balicamp.soap.ws.ikrap.InquiryRequest req
    );
}
