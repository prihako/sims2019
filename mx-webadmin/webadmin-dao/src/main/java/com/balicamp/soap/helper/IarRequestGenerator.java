...
import com.balicamp.soap.ws.iar.ArrayOfString;
import com.balicamp.soap.ws.iar.InquiryRequest;
import com.balicamp.soap.ws.iar.PaymentRequest;
import com.balicamp.soap.ws.iar.StringArray;

@Component
public class IarRequestGenerator {
	...
	public InquiryRequest genereateInquiryRequest(String invoiceNo, String clientId) {
		...
		inquiryRequest.setBillKey3(WebServiceConstant.IAR_TRANSACTION_TYPE);
	...
	public PaymentRequest genereatePaymentRequest(String invoiceNo, 
		...
		paymentRequest.setBillKey3(WebServiceConstant.IAR_TRANSACTION_TYPE);
