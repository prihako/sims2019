...
public abstract class Constants {
	...
	public static Date DEVELOPMENT_DATE = new DateTime(2008, 8, 24, 0, 0, 0, 0)
			.toDate();
	...
	static public class SecurityToken {
		...
		public static final String[] SelectAllSecurity = { SECURITY_TYPE_S,
				SECURITY_TYPE_T };
	...
	static public class TransactionType {
		static public final Map<String, String> transactionType;
		static {
			transactionType = new HashMap<String, String>();
			transactionType.put("10", "BIL");
			transactionType.put("20", "REOR");
			transactionType.put("30", "SKOR");
			transactionType.put("40", "UNAR");
			transactionType.put("50", "IAR");
	...
	static public class BiTypePaid {
		static public final Map<String, String> biTypes;
		static {
			biTypes = new HashMap<String, String>();
			biTypes.put("8", "8");
			biTypes.put("9", "9");
			biTypes.put("10", "10");
			biTypes.put("11", "11");
