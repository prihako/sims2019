...
public interface TransactionFeeManager extends IManager {
	...
	public void deleteAll(List<TransactionFee> allEntities);
	
	public void saveOrUpdateAll(HashMap<TransactionFee, Boolean> allEntities);
	...
	List<TransactionFee> findAllTxFee(String identifier, String epCode, String description, int first, int max);
