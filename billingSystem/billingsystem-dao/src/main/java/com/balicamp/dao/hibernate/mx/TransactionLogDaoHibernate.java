 ...
 */
@Repository
public class TransactionLogDaoHibernate extends MxGenericDaoHibernate<TransactionLogs, Long> implements TransactionLogDao {
	...
	public List<Object> findTransactions(String txCode, String txName,
		...
		hql.append("select distinct txl.id.transactionId, txl.id.transactionTime, " +
				...
				"txl.id.channelRc, eprc.description from Transactions tx, TransactionLogs txl, " +
	...
	public Long findTransactionCount(String txId, String txCode, String txName, String channelCode,
		...
		StringBuffer hql = new StringBuffer();
		hql.append("select count(distinct txl.id.transactionId) from Transactions tx, TransactionLogs txl, " +
				"EndpointRcs eprc, MessageLogs msgl WHERE txl.id.channelCode=eprc.endpoints.code " +
