...
/**
 * Base class dao khusus untuk data akses ke database Admin MX.
 * 
 * @author Wayan Ari Agustina
 * @version $Id: $
 */
public class MXAdminDaoHibernate<T extends BaseAdminModel, PK extends Serializable> extends
		AdminGenericDaoImpl<T, PK> {

	private SessionFactory hibernateSessionFactory;

	public MXAdminDaoHibernate(Class<T> persistentClass) {
