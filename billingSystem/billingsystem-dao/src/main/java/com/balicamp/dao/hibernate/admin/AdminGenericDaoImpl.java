...
import com.balicamp.util.admin.OracleSequenceGenerator;
...
//			PostgreSQLSequenceGenerator seqGenerator = new PostgreSQLSequenceGenerator(getSession());
			OracleSequenceGenerator seqGenerator = new OracleSequenceGenerator(getSession());
			ISequencesModel seqPojo = ((ISequencesModel) pojo);
			String seqName = seqPojo.getSequenceName();
			seqPojo.setId(seqGenerator.next(seqName));
		}
	}
