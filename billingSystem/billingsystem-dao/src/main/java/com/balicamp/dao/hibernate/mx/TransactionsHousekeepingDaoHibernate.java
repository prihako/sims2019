 ...
 * @version $Id: TransactionsDaoHibernate.java 368 2013-03-08 04:09:59Z wayan.agustina $
 */
@Repository("transactionsHousekeepingDaoHibernate")
public class TransactionsHousekeepingDaoHibernate extends MXAdminDaoHibernate<TransactionLogs, Long> implements TransactionsHousekeepingDao {
	...
	public TransactionsHousekeepingDaoHibernate() {
	...
	public List<Object> findTransactions(Object txCode, Object txName, String channelCode, 
		...
		sql.append(
				"order by transaction_time) as temp "+
				"where 1=1 "+
				"group BY " +
				"	temp.transaction_code, " +
				//"	temp.transaction_description, " +
	...
	public int getRowCount(Object txCode, Object txName, String channelCode,
		...
		sql.append(
				...
				"	temp.channel_code, " +
				"	temp.channel_rc, " +
				"	temp.transaction_code) as c) as d");
