...
/**
 * @version $Id: BasePage.java 337 2013-02-19 09:16:01Z bagus.sugitayasa $
 */
public abstract class BasePage extends org.apache.tapestry.html.BasePage {
	...
	public int initPageSize() {
		// FIXME:
		/*
		 * return getSystemParameterManager() .getIntValue( new
		 * SystemParameter(Constants.SystemParameter.Page.GROUP,
