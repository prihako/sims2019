 ...
 *         &lt;element name="paidBills" type="{bankmandiri.h2h.billpayment.ws}ArrayOfString" minOccurs="0"/>
...
public class PaymentRequest {
    ...
    private static String BILL_CODE			= "01";
//    private static String LANGUAGE 			= "01";
//    private static String CHANNEL_ID 			= "5";
//    private static String LOCAL_CURRENCY		= "360";
...
//    	note based on BMRI-POSTEL WS Specification Documents
		...
		map.put("companyCode", getCompanyCode());//mandiri spec
...
//		string.setString(BILL_CODE);
			
//		map.put("paidBills", string.toString());
